...
RUN curl -O http://redrockdigimark.com/apachemirror/hive/hive-${HIVE_VERSION}/apache-hive-${HIVE_VERSION}-bin.tar.gz &&\ 
	tar -zxf ./apache-hive-${HIVE_VERSION}-bin.tar.gz &&\
	mv ./apache-hive-${HIVE_VERSION}-bin $HIVE_HOME 

ADD hive-site.xml.template $HIVE_HOME/conf/hive-site.xml
ADD hive-env.sh.template $HIVE_HOME/conf/hive-env.sh
